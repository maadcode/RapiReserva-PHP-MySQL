...
function writeTable(payments) {
    ...
    payments.forEach(payment => {
        ...
        row.innerHTML = `<td>${payment.voucherCode}</td>
                        ...
                        <td><a href="http://localhost/Projects/RapiReserva/Controllers/paymentsController.php?getPaymentPdf=true&paymentId=${payment.id}"><i class='bx bxs-download'></i></a></td>`;
        row.innerHTML += '</tr>'; 
